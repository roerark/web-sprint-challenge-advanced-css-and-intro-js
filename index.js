...
function addArtist(array, id, name, years, genre, nationaliy, bio){
    array.push({id, name, years, genre, nationaliy, bio});
    return array;
  }
console.log(addArtist(artists, "20", "Joe", "1996-2020", "Web Design", "South Korean", "likes sports"))
